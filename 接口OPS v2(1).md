...
音乐批量加入曲单
    添加音乐到歌单中
    POST /ops/playlist/{uuid}/music_add/
        参数:
            uuids
移除歌单中的音乐
    POST /ops/playlist/{uuid}/music_remove/
        参数:
            uuids
音乐批量下载
    前端JS加入队列下载
...
歌单创建
    POST /ops/playlist/
        参数:
            ...
            cover	封面
            categories	    标签列表
            is_recommend	是否曲单推荐页显示
            is_active	是否激活

歌单更新
    PUT /ops/playlist/{uuid}/
        参数:
            name	歌单名
            desc	描述备注
            cover	封面
            ...
            is_active	是否激活
歌单禁用
    PUT /ops/playlist/{uuid}/inactive/

歌单启用
    PUT /ops/playlist/{uuid}/active/

歌单删除
    DELETE /ops/playlist/{uuid}/

歌单下音乐列表
    GET /ops/playlist/{uuid}/musics/
